...
// number of days in a month of a specific year.
...
public class MonthDays {
	...
	*/
	...
	public void setMonth(int month) { // Method to set month
		// Assign month only if value passed is between 1 and 12 inclusive
		if (month > 0 && month <= 12) {
			this.month = month;
		} else {
			System.out.println("Error: Out of range. Month was not set.");
		}
	}
	...
	public void setYear(int year) { // Method to set year
		...
		if (year > 0 && year <= 1000000) {
			...
			System.out.println("Error: Out of range. Year was not set.");
		}
	}
